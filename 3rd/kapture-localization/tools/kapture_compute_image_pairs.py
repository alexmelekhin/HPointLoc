...
def compute_image_pairs(mapping_path: str,
    ...
    if mapping_path == query_path:
        ...
        with get_all_tar_handlers(query_path) as query_tar_handlers:
            ...
            print(kdata_query.global_features)
    ...
    time_apgem_matching.append((start.elapsed_time(end)/1000))
    ...
    print('average time_apgem_matching: ', sum(time_apgem_matching)/(len(image_pairs)*len(time_apgem_matching)))
